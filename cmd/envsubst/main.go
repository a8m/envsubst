...
var (
	...
	ignoreUnset = flag.Bool("ignore-unset", false, "")
)
...
Options:
  ...
  -ignore-unset Ignore the substitution if a variable is not set.
`
...
func main() {
	...
	restrictions := &parse.Restrictions{*noUnset, *noEmpty, *ignoreUnset}
